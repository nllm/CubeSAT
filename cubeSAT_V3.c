//This program includes the use of three motors wich simulates inertial wheels
...
Motor m(p23, p16, p17); // pwm, fwd, rev
Motor m2(p24, p18, p19); // pwm, fwd, rev
Motor m3(p25, p20, p29); //pwm, fwd, rev
